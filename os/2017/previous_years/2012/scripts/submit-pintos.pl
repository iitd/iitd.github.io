...
sub usage {
	print "Usage: submit-pintos [base|userprog|vm|filesys].\n";
	exit(1);
}
...
sub process_files_filesys
{
	...
	print "Enter the submission-ID of your vm submission (e.g., vm/grp.cs1012345.cs5067890.0.2011-2-26.12:12:12 or userprog/grp.cs1012345.cs5067890.0.2012-2-26.12:12:12). If you have forgotten your submission ID, you can retrieve it by typing 'get-submission $user vm' or 'get-submission $user userprog' which will create a directory named by your vm/userprog submission ID. You will need to prefix it with 'vm/' or 'userprog/' depending on the case.\n";
	my $submission_id = <STDIN>;
	chomp($submission_id);
